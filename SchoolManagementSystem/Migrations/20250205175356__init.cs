    ...
    public partial class _init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Good job!", 1, new DateTime(2025, 2, 5, 23, 53, 54, 569, DateTimeKind.Local).AddTicks(7323), 65, 40, 0, 1, 1, 1, 80 },
                    { 2, "Excellent work!", 0, new DateTime(2025, 2, 5, 23, 53, 54, 569, DateTimeKind.Local).AddTicks(7329), 75, 40, 0, 2, 2, 2, 90 },
                    { 3, "Excellent work!", 0, new DateTime(2025, 2, 5, 23, 53, 54, 569, DateTimeKind.Local).AddTicks(7335), 75, 40, 0, 3, 3, 3, 90 }
                });
